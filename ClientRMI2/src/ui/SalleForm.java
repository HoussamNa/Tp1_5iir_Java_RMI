...
public class SalleForm extends javax.swing.JInternalFrame {
    ...
    private void bnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnUpdateActionPerformed
        ...
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Please select a Salle to update.");
            return;
        }

        int salleId = (int) listSalles.getValueAt(selectedRow, 0);
        String newCode = jTextField1.getText();
        ...
        try {
            ...
            if (salle != null) {
                ...
                JOptionPane.showMessageDialog(this, "Salle updated successfully.");
            } else {
                JOptionPane.showMessageDialog(this, "Salle not found for update.");
            }
        } catch (RemoteException ex) {
            Logger.getLogger(SalleForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void bnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnDeleteActionPerformed
        ...
        if (selectedRow != -1) {
            int selectedSalleId = (int) model.getValueAt(selectedRow, 0);

            try {
                Salle salleToDelete = dao1.findById(selectedSalleId);
                if (salleToDelete != null) {
                    if (dao1.delete(salleToDelete)) {
            ...
            System.err.println("Select a row!!!");
        }
